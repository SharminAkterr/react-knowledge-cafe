    ...
    return (
        <div className='container mx-auto my-10 w-[70%] md:w-[32%]'>
            <div className='border rounded-lg min-h-auto bg-slate-100 mb-6 p-5'>
                <h2 className='text-2xl text-blue-700 font-bold'>Spent time on read : {readingTime} mins </h2>
            </div>


            <div className=' border rounded-lg min-h-auto bg-slate-100'>
                <h2 className='text-2xl my-5 mx-5 font-bold'>Bookmarked Blogs: {bookmarks.length} </h2>
                <div className=''>
                    {/* {
